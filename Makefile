...
install: all
	...
	install -m 0644 data/net.hadess.PowerProfiles.policy $(DESTDIR)$(PREFIX)/share/polkit-1/actions/
	install -m 0644 data/net.hadess.PowerProfiles.conf $(DESTDIR)$(PREFIX)/share/dbus-1/system.d/
...
uninstall:
	...
	rm -f $(DESTDIR)$(PREFIX)/share/polkit-1/actions/net.hadess.PowerProfiles.policy
	rm -f $(DESTDIR)$(PREFIX)/share/dbus-1/system.d/net.hadess.PowerProfiles.conf
